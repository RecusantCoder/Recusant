...
public class DirectionalVectorDisruptor : Weapon
{
    protected new int localWeaponlevel;
    protected new int numOfShots = 9;
    ...
    private int numberOfProjectilesAllowed = 9;
    ...
    {
        Debug.Log("numSpawned: " + numberOfProjectilesSpawned + " numAllowed: " + numberOfProjectilesAllowed);
        if (numberOfProjectilesSpawned < numberOfProjectilesAllowed)
        {
            GameObject DVDAttack = Instantiate(Resources.Load<GameObject>("PreFabs/Projectiles/DVDAttack"),
